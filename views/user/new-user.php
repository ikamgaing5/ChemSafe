                                    ...
                                    <div class="col-xl-6 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nomuser" name="nom"
                                                placeholder="Entrez le nom d'utilisateur" value="<?= $nomuser ?>">
                                    ...
                                    <div class="col-xl-6 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="password" name="password"
                                                placeholder="Entrez le mot de passe" maxlenght="6">
                                            <span id="messageMdp" class="fw-bold text-danger"></span>
                                        </div>

                                        <div class="mb-3">
                                            <label style="font-weight: 700;" for="exampleFormControlInput8"
                                                class="form-label text-primary">Adrese mail<span
                                                    class="required">*</span></label>
                                            <input type="text" class="form-control" id="password" name="email"
                                                placeholder="Entrez l'adresse mail" maxlenght="6">
