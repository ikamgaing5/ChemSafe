...
<div class="container">
    ...
    <table table-striped>
<tr><th>Nom</th><th>Emballage</th><th>Ateliers</th><th>Voir FDS</th><th>Voir Photo</th></tr>
<?php
...
?>
    ...
    <td><button type='button' class='btn btn-primary shadow btn-xs sharp me-1' data-bs-toggle='modal' data-bs-target='#modalPhotoProduit<?=$prod['idprod']?>'>Voir Photo</button></td>
    </tr>
...
<!-- Modal Bootstrap FDS -->
<div class="modal fade" id="modalFDSProduit<?= $prod['idprod'] ?>" tabindex="-1" aria-labelledby="fdsModalLabel<?= $prod['idprod'] ?>" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body text-center">
        <iframe src="../../uploads/fds/<?= htmlspecialchars($prod['fds']) ?>" style="width:100%; height:80vh;" frameborder="0"></iframe>
      </div>
    </div>
  </div>
</div>
