								...
								<form action="/" method="POST">
									<div class="text-center mb-4">
										...
										if (isset($_SESSION['deconnect'])) {
											...
											echo '<div class="mx-3 alert alert-success alert-dismissible fade show">
									...
									<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close">
										...
										if (isset($_SESSION['offff'])) {
											...
											echo '<div class="mx-3 alert alert-danger alert-dismissible fade show">
									<svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="me-2"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>
									...
									<div class="mb-3 mx-3">
										...
										<input type="text" class="form-control" name="nom" id="exampleFormControlInput1"
											value="<?php if (isset($_SESSION['login_failed'])) {
												echo $_SESSION['login_failed']['info']['nom'];
											}
											if (isset($_SESSION['info'])) {
												echo $_SESSION['info']['nom'];
											} ?>">
