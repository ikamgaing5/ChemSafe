<?php
    ...
    Route::add('GET', '/dashboard', [$UserController, 'dashboard']);
    ...
    Route::add('GET', '/workshop/all-workshop', [$AtelierController, 'all'], [AuthMiddleware::class]);
    ...
    Route::add('GET', '/info-fds/new-info-fds', [$FdsController, 'Insert'], [AuthMiddleware::class]);
